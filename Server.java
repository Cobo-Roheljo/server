...
public class Server {
    ...
    public Socket attendi()
    {
        ...
        catch (Exception e)
        {
            ...
            System.out.println("Errore dutante l'istanza dle server !");
            System.exit(1);
            System.exit(1);
        }
        return client;
    ...
    public void comunica()
    {
        try
        {
            //rimango in attesa della riga transmessa dal client
            System.out.println("3 benvenuto client, scrivi una frase e la transformo in maiuscolo. Attendo ...");
            ...
            System.out.println("7 invio la stringa la stringa modificata al client ...");
